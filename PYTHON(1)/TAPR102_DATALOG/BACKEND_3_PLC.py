...
#=======================================================================================================================
    ...
    if Z.registers[0] == 1:
        ...
        y6 = 271  # 71-72 Glue Weight
        y7 = 272  # 73 Cycle Weight
        ...
        STATION_NAME = for_list(a31)
        PROCESS_NAME = for_list(a41)
...
# =======================================================================================================================
    ...
    if Z.registers[0] == 1:
        ...
        y6 = 471  # 71-72 Glue Weight
        y7 = 472  # 73 Cycle Weight
        ...
        STATION_NAME = for_list(a32)
        PROCESS_NAME = for_list(a42)
